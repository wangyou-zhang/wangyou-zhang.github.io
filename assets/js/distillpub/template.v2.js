...
`);
  ...
  function link_string(ent) {
    if ("url" in ent) {
      ...
      return ` &ensp;<a href="${url}" style="color:var(--global-link-color)">[${label || "link"}]</a>`;
    } /* else if ("doi" in ent){
  ...
  function doi_string(ent, new_line) {
    if ("doi" in ent) {
      ...
      ent.doi
    }" style="text-decoration:inherit; color:var(--global-link-color)">DOI: ${ent.doi}</a>`;
    } else {
      return "";
    }
  }
...
.citation-number::selection {
  color: var(--global-link-color-visited);
  background: rgba(187, 214, 251, 1.0);
}
...
ul li {
  ...
  border-bottom: 1px solid var(--global-link-color)
}
...
`;
  ...
  ********************************************** */
  ...
  var css = "/**\n * prism.js default theme for JavaScript, CSS and HTML\n * Based on dabblet (http://dabblet.com)\n * @author Lea Verou\n */\n\ncode[class*=\"language-\"],\npre[class*=\"language-\"] {\n\tcolor: var(--global-text-color);\n\tbackground: none;\n\ttext-shadow: 0 1px var(--global-bg-color);\n\tfont-family: Consolas, Monaco, 'Andale Mono', 'Ubuntu Mono', monospace;\n\tfont-size: 1em;\n\ttext-align: left;\n\twhite-space: pre;\n\tword-spacing: normal;\n\tword-break: normal;\n\tword-wrap: normal;\n\tline-height: 1.5;\n\n\t-moz-tab-size: 4;\n\t-o-tab-size: 4;\n\ttab-size: 4;\n\n\t-webkit-hyphens: none;\n\t-moz-hyphens: none;\n\t-ms-hyphens: none;\n\thyphens: none;\n}\n\npre[class*=\"language-\"]::-moz-selection, pre[class*=\"language-\"] ::-moz-selection,\ncode[class*=\"language-\"]::-moz-selection, code[class*=\"language-\"] ::-moz-selection {\n\ttext-shadow: none;\n\tbackground: #b3d4fc;\n}\n\npre[class*=\"language-\"]::selection, pre[class*=\"language-\"] ::selection,\ncode[class*=\"language-\"]::selection, code[class*=\"language-\"] ::selection {\n\ttext-shadow: none;\n\tbackground: #b3d4fc;\n}\n\n@media print {\n\tcode[class*=\"language-\"],\n\tpre[class*=\"language-\"] {\n\t\ttext-shadow: none;\n\t}\n}\n\n/* Code blocks */\npre[class*=\"language-\"] {\n\tpadding: 1em;\n\tmargin: .5em 0;\n\toverflow: auto;\n}\n\n:not(pre) > code[class*=\"language-\"],\npre[class*=\"language-\"] {\n\tbackground: var(--global-bg-color);\n}\n\n/* Inline code */\n:not(pre) > code[class*=\"language-\"] {\n\tpadding: .1em;\n\tborder-radius: .3em;\n\twhite-space: normal;\n}\n\n.token.comment,\n.token.prolog,\n.token.doctype,\n.token.cdata {\n\tcolor: var(--global-code-comment-color);\n}\n\n.token.punctuation {\n\tcolor: #999;\n}\n\n.token.namespace {\n\topacity: .7;\n}\n\n.token.boolean {\n\tcolor: var(--global-code-boolean-color);\n}\n\n.token.property,\n.token.tag,\n.token.number,\n.token.constant,\n.token.symbol,\n.token.deleted {\n\tcolor: var(--global-code-number-color);\n}\n\n.token.selector,\n.token.attr-name,\n.token.string,\n.token.char,\n.token.builtin,\n.token.inserted {\n\tcolor: var(--global-code-builtin-color);\n}\n\n.token.operator,\n.token.entity,\n.token.url,\n.language-css .token.string,\n.style .token.string {\n\tcolor: var(--global-code-token-color);\n\tbackground: none;\n}\n\n.token.atrule,\n.token.attr-value,\n.token.keyword {\n\tcolor: var(--global-code-keyword-color);\n}\n\n.token.function,\n.token.class-name {\n\tcolor: var(--global-code-classname-color);\n}\n\n.token.regex,\n.token.important,\n.token.variable {\n\tcolor: var(--global-code-variable-color);\n}\n\n.token.important,\n.token.bold {\n\tfont-weight: bold;\n}\n.token.italic {\n\tfont-style: italic;\n}\n\n.token.entity {\n\tcursor: help;\n}\n";
...
<code id="code-container" style="overflow-x: scroll;"></code>
...
.panel {
  ...
  box-shadow: 0 0 7px var(--global-border-color);
  border-radius: 4px;
  box-sizing: border-box;
...
<style>
  ...
  .ticks .tick {
    position: absolute;
    height: 100%;
    border-left: 1px solid var(--global-dark-border-color);
  }
...
distill-header {
  ...
  box-shadow: 0 1px 6px var(--global-bg-color);
}
...
:host {
  ...
  background-color: var(--global-text-color); /*hsl(200, 60%, 15%);*/
  text-align: left;
  contain: content;
}
