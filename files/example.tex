...
\usepackage{arydshln}              % for using \hdashline (dashed lines in tables)
...
\begin{figure*}
  \centering
  \includegraphics[width=0.88\textwidth]{../images/remark.js/logo_audiocc.png}
...
\begin{table}[t]
    ...
    \resizebox{1.0\columnwidth}{!}{% <---- don't forget this %
        ...
        & synthetic & (suspiciously)\,synthetic speech & 0 &  \\[2pt]
        \hdashline\noalign{\vskip 2pt}
